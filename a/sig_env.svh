class sig_env extends hdv_env#(hdv_env_cfg, sig_scoreboard, hdv_env_cov);
  ...
  virtual function void connect_phase(uvm_phase phase);
    ...
    sig_agnt_d.monitor.analysis_port.connect(scoreboard.rsp_fifo.analysis_export);
    sig_agnt_m.monitor.analysis_port.connect(scoreboard.req_fifo.analysis_export);
